...
check_cmd "Java (JDK 21)" "java" "java -version"
check_cmd "Javac (Compilador)" "javac" "javac -version"
check_cmd "Android CLI" "android" "android --version"
check_cmd "Android SDKManager" "sdkmanager" "sdkmanager --version"
check_cmd "ADB" "adb" "adb --version"
